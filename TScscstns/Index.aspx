...
<section class="slider-pro slider" id="slider">
	<div class="sp-slides">
		...
		<div class="sp-slide main-slides">
			...
			<span class="highlight-texts">We love Design</span>
			</h1>
		...
		<div class="img-overlay"></div>
			...
			<h1 class="sp-layer slider-text-big"
			data-position="center" data-show-transition="left" data-hide-transition="right" data-show-delay="1500" data-hide-delay="200">
			<span class="highlight-texts">Business Solutions</span>
			</h1>
		...
		<div class="sp-slide main-slides">
			...
			<h1 class="sp-layer slider-text-big"
			data-position="center" data-show-transition="left" data-hide-transition="right" data-show-delay="1500" data-hide-delay="200">
			<span class="highlight-texts">Responsive Website</span>
			</h1>
		...
		<div class="row"> 
			...
			<div class="col-md-6 nopaddingnomargin">
				<div class="content-right">
					<h3>Professional Clean Awesome Unlimited <b>Feautures Theme!</b></h3>
	...
	<div class="wow fadeInUpQuick" data-wow-delay=".9s"> 
	  <div class="row" id="clients-carousel">
		<div class="client-item-wrapper">
		  <img src="images/clients/amazon.png" alt="">
		</div>
		<div class="client-item-wrapper">
		  <img src="images/clients/ebay.png" alt="">
		</div>
		<div class="client-item-wrapper">
		  <img src="images/clients/google.png" alt="">
		</div>
		<div class="client-item-wrapper">
		  <img src="images/clients/vadafone.png" alt="">
		</div>
		<div class="client-item-wrapper">
		  <img src="images/clients/spinworkx.png" alt="">
		</div>
		<div class="client-item-wrapper">
		  <img src="images/clients/cocacola.png" alt="">
		</div>
	  </div>
	</div>
	 </div>
	...
	<div class="container">
		<div class="row">
			<div class="footer-containertent">
				...
				<br/><br/>
				<p>厦门天擎网络科技有限公司 | 地址：厦门市思明区嘉禾路新景中心A栋1902 咨询电话0592-6039111项目经理热线18965167001 E-mail:service@teamsking.net
Copyright © 2000-2020 http://www.teamsking.com.cn 闽ICP备05026423号-5</p>
			</div>
		</div>
	</div>
</footer>
